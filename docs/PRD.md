...
**문서 버전:** v1.6
**작성일:** 2026-09-10 (최종 갱신: 2026-09-12)
**프로젝트명(가칭):** 리딩버디 (Reading Buddy) — 추후 변경 가능
