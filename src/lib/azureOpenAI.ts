      ...
      messages: [
        {
          ...
          content: [
            ...
            ...(bookContext
              ? [
                  `책 줄거리 요약(참고용, 아이에게 그대로 읽어주지 말 것): ${bookContext}`,
                  // 요약을 그냥 참고만 하고 "가장 큰 사건이 뭐였어?" 같은 어떤 책에나 통하는
                  // 질문을 내놓는 문제가 있었다(2026-09-12 사용자 피드백) — 반드시 구체적인
                  // 내용을 질문에 넣도록 명시적으로 강제한다.
                  "질문에는 위 줄거리 요약에 나온 구체적인 사건이나 인물 이름을 최소 하나는 넣어서, 이 책 얘기라는 게 분명히 드러나게 물어라. 요약이 짧아서 구체적인 사건을 찾기 어려우면, 요약에 나온 인물이나 장소 이름만이라도 반드시 활용해라.",
                ]
